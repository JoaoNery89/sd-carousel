...
import BitmovinApi, { Player, PlayerEvent } from '@bitmovin/api-sdk'
//import { Player, PlayerEvent } from 'bitmovin-player'

require("./style.scss")

const config = new BitmovinApi({
  apiKey: 'MY-PLAYER-KEY' // Solicitar no site
})

const player = new bitmovin.player.Player(document.getElementById('bitMovPlayer'), config)
