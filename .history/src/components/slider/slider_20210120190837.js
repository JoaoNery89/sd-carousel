...
const player = new config.player.Player(document.getElementById('bitMovPlayer'), config)

player.on(config.player.PlayerEvent.Playing, () => console.log('player is playing'))
