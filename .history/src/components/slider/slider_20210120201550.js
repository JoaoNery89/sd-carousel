...
import BitmovinApi, { Player } from '@bitmovin/api-sdk'
import { UIFactory } from 'bitmovin-player-ui'

require("./style.scss")

const container = document.getElementById('btm-player')

const playerConfig = new BitmovinApi ({
...
// const player = new BitmovinApi.player.Player(container, playerConfig)
...
const player = new Player(document.getElementById('container-id'), playerConfig)
