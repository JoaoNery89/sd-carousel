...
const config = new BitmovinApi({
  apiKey: '<API_KEY>' // Solicitar no site
})

// const createInput = await bitmovinApi.encoding.inputs.https.create(
//   new HttpsInput({
...
// const getInput = await bitmovinApi.encoding.inputs.https.get(
//   '<INPUT_ID>'
// );
