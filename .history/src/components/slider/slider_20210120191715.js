...
const bitmovinApi = new BitmovinApi({
  apiKey: '6b36d30b-76bb-423e-958f-9428555458de'
})

// const player = new bitmovinApi.player.Player(document.getElementById('bitMovPlayer'), bitmovinApi)

// player.on(bitmovinApi.player.PlayerEvent.Playing, () => console.log('player is playing'))

// player.load({
//   dash: 'https://path/to/mpd/file.mpd',
//   hls: 'https://ecbahia.tvnanuvem.com/hls/6075202829fd11eb8679c26f739b3ce9/playlist.m3u8',
...
const input = await bitmovinApi.encoding.inputs.https.create(
  new HttpsInput({
    host: 'https://ecbahia.tvnanuvem.com/hls/6075202829fd11eb8679c26f739b3ce9/playlist.m3u8',
    name: 'btmPlayer'
  })
)
